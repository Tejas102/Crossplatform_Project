...
function connectToDatabase() {
    ...
    if (!db) {
        ...
        db.transaction(
                       function(tx){
                       tx.executeSql(
                                     "CREATE TABLE IF NOT EXISTS user (id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT, password TEXT, name TEXT, birthdate TEXT, location TEXT, description Text, phone TEXT)",
                                     [],
                                     onSuccessExecuteSql,
                                     onError
                                     )
