...
//     }
//
//     var users1 = ["tejas", "sukh", "jao", "shivam"];
//
//        // tx.executeSql('SELECT * FROM users where id=1', [], onSuccessExecuteSql,
//        // onSuccess1,
//        // onError);
//
//       // tx.executeSql('INSERT INTO users (email, password, name, dob, location) VALUES ("tejas", "First row","First row","First row","First row")');
//       // tx.executeSql('INSERT INTO users (email, password, name, dob, location) VALUES ("tejas2", "second row","First row","First row","First row")');
//       // tx.executeSql('INSERT INTO users (email, password, name, dob, location) VALUES ("tejas3", "third row","First row","First row","First row")');
//       // tx.executeSql('INSERT INTO users (email, password, name, dob, location) VALUES ("tejas4", "Forth row","First row","First row","First row")');
//
//    }
//
...
// 			tx.executeSql(
// 				"CREATE TABLE IF NOT EXISTS users (id INTEGER PRIMARY KEY AUTOINCREMENT, email TEXT, password TEXT, name TEXT, dob TEXT, location  TEXT)",
// 				[],
// 				onSuccessExecuteSql,
// 				onError
// 			)
